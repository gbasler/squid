...
g = (\f'4 -> (\x' -> (_4(# ((_5(# f'4 #)) _6), ((_5(# f'4 #)) x') #))))

_4(# f'5, f'6 #) = (((GHC.Num.+) f'6) f'5)

_5(# f'4 #) = f'4

_6 = (GHC.Num.fromInteger 3)

gTest0 = (_4(# (_7(# _6 #)), (_7(# 2 #)) #))

_7(# ds'4 #) = (((GHC.Num.+) ds'4) 1)

gTest1 = (((GHC.Num.+) (((GHC.Num.+) (_4(# (_7(# _6 #)), (_7(# 2 #)) #))) 1)) (((GHC.Num.+) (GHC.Num.fromInteger 3)) 1))
