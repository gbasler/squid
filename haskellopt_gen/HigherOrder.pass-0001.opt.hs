...
--                          eta-expand,
--                          case-of-case}
-- Total nodes: 344; Boxes: 88; Branches: 56
-- Apps: 91; Lams: 12; Unreduced Redexes: 0
...
i = (\f'4 -> (_8(# {-A-}\(x'5) -> (f'4 (\ds'3 -> (_9(# ds'3 #)))), {-A-}\(x'5) -> (f'4 (\ds'4 -> (_10(# ds'4 #)))) #)))

_8(# f'11, f'12 #) = (\x'5 -> (_14(# {-P-}(f'11(x'5)), {-P-}(f'12(x'5)) #)))

_9(# ds'7 #) = (((GHC.Num.+) ds'7) (GHC.Types.I# 1#))

_10(# ds'8 #) = (((GHC.Num.*) ds'8) (GHC.Types.I# 2#))

iTest0 = (_8(# {-A-}\(x'5) -> (_11(# (_9(# _12 #)), (_9(# _13 #)) #)), {-A-}\(x'5) -> (_11(# (_10(# _12 #)), (_10(# _13 #)) #)) #))
