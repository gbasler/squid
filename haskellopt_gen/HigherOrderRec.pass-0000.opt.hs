...
_13(# x'2, f'14, f'15 #) = (((GHC.Num.-) (sx(# x'2 #))) (((GHC.Num.*) (f'14 (_13(# (sx(# x'2 #)), f'15, f'14 #)))) (f'14 (_13(# (sx(# x'2 #)), f'14, f'14 #)))))
...
rec1 = (\f'18 -> (\x'5 -> (_3(# f'18, f'18 #))))

rec2 = (\f'19 -> (\x'6 -> (_4(# x'6, f'19, f'19 #))))

rec3 = (\f'20 -> (\x'7 -> (\y' -> (_5(# y', f'20, f'20, x'7 #)))))

rec7 = (\f'21 -> (_8(# \(ds') -> (_0(# f'21, f'21, f'21 #)) #)))

rec7Test0 = (_8(# \(ds') -> (_0(# _9, _9, _9 #)) #))

rec7Test1 = (_8(# \(ds') -> (_10(# (_1(# _11, _11 #)) #)) #))

rec7Test2 = (((GHC.Base.$) (GHC.List.take (GHC.Types.I# 3#))) (_6(# (), (_0(# _12, _12, _12 #)) #)))

rec8 = (\f'22 -> (\x'8 -> (_13(# x'8, f'22, f'22 #))))
