...
main = (GHC.TopHandler.runMainIO (Criterion.Main.defaultMain (((:) (((GHC.Base.$) (Criterion.Measurement.Types.bench (GHC.CString.unpackCString# "max"#))) ((Criterion.Measurement.Types.nf sumnats) (GHC.Types.I# 42#)))) [])))
