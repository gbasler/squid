...
--                          eta-expand,
--                          case-of-case}
-- Total nodes: 438; Boxes: 93; Branches: 46
...
process = (\a -> (_1(# a, Data.Foldable.sum #)))

processLocal = (\arg'2 -> (((GHC.Num.+) (_5(# (Data.Foldable.sum (GHC.Base.build (\c'3 -> (\n'3 -> (_6(# c'3, (_7(# arg'2 #)), n'3, values' #)))))) #))) (_5(# (Data.Foldable.sum (GHC.Base.build (\c'4 -> (\n'4 -> (_6(# (((GHC.Base..) c'4) (\x'3 -> (((GHC.Num.*) x'3) (GHC.Types.I# 2#)))), (_7(# (((GHC.Num.+) arg'2) (GHC.Types.I# 1#)) #)), n'4, values' #)))))) #))))

_5(# sf'3 #) = (((GHC.Num.+) (((GHC.Num.*) sf'3) sf'3)) (GHC.Num.fromInteger 1))

_6(# c'5, f, n'5, xs' #) = (((GHC.Base.foldr (((GHC.Base..) c'5) f)) n'5) xs')

_7(# arg'3 #) = (\ds'3 -> (((GHC.Num.+) ds'3) arg'3))
...
_4(# arg'4 #) = (\ds'4 -> (((GHC.Num.+) ds'4) arg'4))
