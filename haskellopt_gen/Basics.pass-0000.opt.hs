...
--   desugar
-- Total nodes: 188; Boxes: 79; Branches: 52
-- Apps: 129; Lams: 4; Unreduced Redexes: 0
...
gTest2 = (_1(# {-A-}\(y') -> (_2(# (GHC.Types.I# 3#), (GHC.Types.I# 2#) #)) #))
...
gTest5 = (((GHC.Num.+) (_2(# (_3(# _4 #)), (_5(# _4 #)) #))) (_2(# (_3(# _6 #)), (_5(# _6 #)) #)))
