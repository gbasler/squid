...
_8(# f'13 #) = (\ds'2 -> (_6(# ds'2, {-P-}(f'13(ds'2)) #)))

_9(# ds'3 #) = (((GHC.Num.*) ds'3) 2)

_10 = ((:) 1)

_11(# x'3, f'14 #) = (((GHC.Num.-) (sx(# x'3 #))) (((GHC.Num.*) (f'14 (_11(# (sx(# x'3 #)), f'14 #)))) (f'14 (_11(# (sx(# x'3 #)), f'14 #)))))
...
rec1 = (\f'17 -> (\x'7 -> (_3(# f'17, f'17 #))))

rec2 = (\f'18 -> (\x'4 -> (_4(# x'4, f'18, f'18 #))))

rec3 = (\f'19 -> (\x'5 -> (\y' -> (_5(# y', f'19, f'19, x'5 #)))))

rec7 = (\f'20 -> (_8(# {-A-}\(ds'2) -> (_0(# f'20, f'20, f'20 #)) #)))

rec7Test0 = (_8(# {-A-}\(ds'2) -> (_0(# rec7Test0', rec7Test0', rec7Test0' #)) #))

rec7Test0' = ((GHC.Num.+) 1)

rec7Test1' = (\ds'4 -> (_9(# ds'4 #)))

rec7Test1 = (_8(# {-A-}\(ds'2) -> (_9(# (_1(# rec7Test1', rec7Test1' #)) #)) #))
