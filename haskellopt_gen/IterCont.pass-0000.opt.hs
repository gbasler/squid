...
--   desugar
-- Total nodes: 151; Boxes: 31; Branches: 21
-- Apps: 36; Lams: 8; Unreduced Redexes: 2
...
_0(# f, s #) = (case (((GHC.Classes.>) s) (GHC.Num.fromInteger 0)) of {False -> (GHC.Num.fromInteger 0); True -> (((GHC.Num.+) f) (GHC.Num.fromInteger 1))})
...
n5 = ((GHC.List.take (_0(# (_4(# (_2(# 5 #)) #)), 5 #))) nats)
