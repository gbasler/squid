...
--   desugar
-- Total nodes: 436; Boxes: 91; Branches: 46
-- Apps: 125; Lams: 27; Unreduced Redexes: 0
...
process = (_4(# Data.Foldable.sum #))

processLocal = (\arg'3 -> (((GHC.Num.+) (_6(# (Data.Foldable.sum (GHC.Base.build (\c'3 -> (\n'3 -> (_7(# c'3, (_8(# arg'3 #)), n'3, values' #)))))) #))) (_6(# (Data.Foldable.sum (GHC.Base.build (\c'4 -> (\n'4 -> (_7(# (((GHC.Base..) c'4) (\x'3 -> (((GHC.Num.*) x'3) (GHC.Types.I# 2#)))), (_8(# (((GHC.Num.+) arg'3) (GHC.Types.I# 1#)) #)), n'4, values' #)))))) #))))

_6(# sf'5 #) = (((GHC.Num.+) (((GHC.Num.*) sf'5) sf'5)) (GHC.Num.fromInteger 1))

_7(# c'5, f, n'5, xs' #) = (((GHC.Base.foldr (((GHC.Base..) c'5) f)) n'5) xs')

_8(# arg'4 #) = (\ds -> (((GHC.Num.+) ds) arg'4))
...
_3(# arg'5 #) = (\ds'3 -> (((GHC.Num.+) ds'3) arg'5))
