...
--   desugar
-- Total nodes: 312; Boxes: 100; Branches: 74
-- Apps: 63; Lams: 9; Unreduced Redexes: 0
...
_7(# f'17, f'18 #) = (((GHC.Num.*) f'17) f'18)
...
_14(# x' #) = (((GHC.Num.*) x') (_7(# (_25(# _8, x' #)), (_25(# _9, x' #)) #)))

i = (\f'3 -> (_15(# {-A-}\(x'3) -> (f'3 (\ds -> (_16(# ds #)))), {-A-}\(x'3) -> (f'3 (\ds' -> (_17(# ds' #)))) #)))

_15(# f'11, f'12 #) = (\x'3 -> (_21(# {-P-}(f'11(x'3)), {-P-}(f'12(x'3)) #)))

_16(# ds'3 #) = (((GHC.Num.+) ds'3) (GHC.Types.I# 1#))

_17(# ds'4 #) = (((GHC.Num.*) ds'4) (GHC.Types.I# 2#))

iTest0 = (_15(# {-A-}\(x'3) -> (_18(# (_16(# _19 #)), (_16(# _20 #)) #)), {-A-}\(x'3) -> (_18(# (_17(# _19 #)), (_17(# _20 #)) #)) #))
