...
_17(# f'2, f'3 #) = (((GHC.Num.+) f'2) f'3)

_18(# ds' #) = (((GHC.Num.+) ds') (GHC.Types.I# 1#))

_19 = (\ds'5 -> (_18(# ds'5 #)))

_20(# ds'2 #) = (((GHC.Num.*) ds'2) (GHC.Types.I# 2#))

_21 = (\ds'6 -> (_20(# ds'6 #)))

_22(# f'4, f'5 #) = (((GHC.Num.+) f'4) f'5)

_23(# f'6, f'7 #) = (\x'2 -> (_22(# (f'6(x'2)), (f'7(x'2)) #)))

_24(# f'8 #) = (((GHC.Num.+) (f'8 (GHC.Types.I# 11#))) (f'8 (GHC.Types.I# 22#)))

_25 = (GHC.Types.I# 11#)

_26 = (GHC.Types.I# 22#)

_27(# f'9, f'10 #) = (((GHC.Num.+) f'10) f'9)

_4 = (GHC.Types.I# 2#)

_3 = (GHC.Types.I# 3#)

_1(# f'11, f'12 #) = (((GHC.Num.*) f'12) f'11)

_28(# ds'3 #) = (((GHC.Num.+) ds'3) (GHC.Types.I# 1#))

_29(# ds'4 #) = (((GHC.Num.*) ds'4) (GHC.Types.I# 2#))

_2(# x'3, y #) = (((GHC.Num.-) x'3) y)

f0 = (\f'15 -> (_17(# (f'15 _15), (f'15 _16) #)))

g = (\f'14 -> (\x'4 -> (_14(# ((_13(# f'14 #)) x'4), ((_13(# f'14 #)) _8) #))))
...
i = (\f'13 -> (_23(# \(x'2) -> ((_12(# f'13 #)) _19), \(x'2) -> ((_12(# f'13 #)) _21) #)))

iTest0 = (_23(# \(x'2) -> (_24(# _19 #)), \(x'2) -> (_24(# _21 #)) #))
