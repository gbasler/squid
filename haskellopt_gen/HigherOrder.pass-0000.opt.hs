...
_10(# f'15, f'16 #) = (((GHC.Num.*) f'16) f'15)
...
_17(# x' #) = (((GHC.Num.*) x') (_10(# (_29(# x', _11 #)), (_29(# x', _12 #)) #)))

i = (\f'2 -> (_18(# {-A-}\(x'3) -> ((_19(# f'2 #)) _20), {-A-}\(x'3) -> ((_19(# f'2 #)) _21) #)))

_18(# f'10, f'11 #) = (\x'3 -> (_23(# {-P-}(f'10(x'3)), {-P-}(f'11(x'3)) #)))
...
iTest0 = (_18(# {-A-}\(x'3) -> (_22(# _20 #)), {-A-}\(x'3) -> (_22(# _21 #)) #))
