...
foo_6_5 = \x -> let
  rec p'3 = let
        ...
        rec'5 p'4 = let
              ...
              _8 = p'4 + (1::Int)
              _9 = _8 * (2::Int)
              in p'4 : (case mod p'4 (2::Int) == (0::Int) of { True -> _8 : (case mod _8 (2::Int) == (0::Int) of { True -> (rec (_8 + (1::Int))); False -> _9 : (case mod _9 (2::Int) == (0::Int) of { True -> (rec (_9 + (1::Int))); False -> (rec'5 (_9 * (2::Int))) }) }); False -> _7 : (case mod _7 (2::Int) == (0::Int) of { True -> _10 : (case mod _10 (2::Int) == (0::Int) of { True -> (rec (_10 + (1::Int))); False -> (rec'5 (_10 * (2::Int))) }); False -> (rec'5 (_7 * (2::Int))) }) })
  ...
  rec' p = let
        ...
        rec'2 p' = let
              ...
              _3 = p' * (2::Int)
              _4 = _3 + (1::Int)
              in p' : (case mod p' (2::Int) == (0::Int) of { True -> _1 : (case mod _1 (2::Int) == (0::Int) of { True -> (rec'2 (_1 + (1::Int))); False -> _2 : (case mod _2 (2::Int) == (0::Int) of { True -> (rec'2 (_2 + (1::Int))); False -> (rec' (_2 * (2::Int))) }) }); False -> _3 : (case mod _3 (2::Int) == (0::Int) of { True -> _4 : (case mod _4 (2::Int) == (0::Int) of { True -> (rec'2 (_4 + (1::Int))); False -> (rec' (_4 * (2::Int))) }); False -> (rec' (_3 * (2::Int))) }) })
...
foo_5_10 = let
  rec p = let
        rec' p' = let
              ...
              _2 = p' * (2::Int)
              _3 = _2 + (1::Int)
              in p' : ((_0 : ((rec (_0 + (1::Int))) ++ (_1 : ((rec (_1 + (1::Int))) ++ (rec' (_1 * (2::Int))))))) ++ (_2 : ((_3 : ((rec (_3 + (1::Int))) ++ (rec' (_3 * (2::Int))))) ++ (rec' (_2 * (2::Int))))))
        _4 = p + (1::Int)
        rec'2 p'2 = 
              let _5 = p'2 * (2::Int) in
              p'2 : ((rec (p'2 + (1::Int))) ++ (_5 : ((rec (_5 + (1::Int))) ++ (rec'2 (_5 * (2::Int))))))
        in p : ((_4 : ((rec (_4 + (1::Int))) ++ (rec'2 (_4 * (2::Int))))) ++ (rec' (p * (2::Int))))
  rec'3 p'3 = let
        rec'4 p'4 = let
              _6 = p'4 * (2::Int)
              _9 = _6 + (1::Int)
              _7 = p'4 + (1::Int)
              _8 = _7 * (2::Int)
              in p'4 : ((_7 : ((rec'4 (_7 + (1::Int))) ++ (_8 : ((rec'4 (_8 + (1::Int))) ++ (rec'3 (_8 * (2::Int))))))) ++ (_6 : ((_9 : ((rec'4 (_9 + (1::Int))) ++ (rec'3 (_9 * (2::Int))))) ++ (rec'3 (_6 * (2::Int))))))
        _10 = p'3 * (2::Int)
        rec'5 p'5 = 
              let _11 = p'5 + (1::Int) in
              p'5 : ((_11 : ((rec'5 (_11 + (1::Int))) ++ (rec'3 (_11 * (2::Int))))) ++ (rec'3 (p'5 * (2::Int))))
        in p'3 : ((rec'4 (p'3 + (1::Int))) ++ (_10 : ((rec'5 (_10 + (1::Int))) ++ (rec'3 (_10 * (2::Int))))))
  in GHC.List.take (10::Int) ((23::Int) : ((rec ((23::Int) + (1::Int))) ++ (rec'3 ((23::Int) * (2::Int)))))
...
foo_5 = \s -> let
  ...
  rec' p = let
        rec'2 p' = let
              ...
              _1 = p' + (1::Int)
              _2 = _1 * (2::Int)
              in p' : ((_1 : ((rec'2 (_1 + (1::Int))) ++ (_2 : ((rec'2 (_2 + (1::Int))) ++ (rec' (_2 * (2::Int))))))) ++ (_0 : ((_3 : ((rec'2 (_3 + (1::Int))) ++ (rec' (_3 * (2::Int))))) ++ (rec' (_0 * (2::Int))))))
        _4 = p * (2::Int)
        rec'3 p'2 = 
              let _5 = p'2 + (1::Int) in
