...
-- Field reductions: 0
-- Case commutings:  0
-- Total nodes: 1190; Boxes: 396; Branches: 396
-- Apps: 186; Lams: 25
...
module HigherOrderRecLocal (foo_6,foo_5,foo_4,foo_3,foo_1,foo_0,foo) where
...
foo_6 = \s -> let
  rec p'3 = let
        rec'4 p'4 = 
              let _6 = p'4 * (2::Int) in
              p'4 : (case mod p'4 (2::Int) == (0::Int) of { True -> (rec (p'4 + (1::Int))); False -> _6 : (case mod _6 (2::Int) == (0::Int) of { True -> (rec (_6 + (1::Int))); False -> (rec'4 (_6 * (2::Int))) }) })
        _7 = p'3 + (1::Int)
        rec'5 p'5 = let
              _8 = p'5 + (1::Int)
              _9 = _8 * (2::Int)
              _10 = p'5 * (2::Int)
              _11 = _10 + (1::Int)
              in p'5 : (case mod p'5 (2::Int) == (0::Int) of { True -> _8 : (case mod _8 (2::Int) == (0::Int) of { True -> (rec (_8 + (1::Int))); False -> _9 : (case mod _9 (2::Int) == (0::Int) of { True -> (rec (_9 + (1::Int))); False -> (rec'5 (_9 * (2::Int))) }) }); False -> _10 : (case mod _10 (2::Int) == (0::Int) of { True -> _11 : (case mod _11 (2::Int) == (0::Int) of { True -> (rec (_11 + (1::Int))); False -> (rec'5 (_11 * (2::Int))) }); False -> (rec'5 (_10 * (2::Int))) }) })
        in p'3 : (case mod p'3 (2::Int) == (0::Int) of { True -> _7 : (case mod _7 (2::Int) == (0::Int) of { True -> (rec (_7 + (1::Int))); False -> (rec'4 (_7 * (2::Int))) }); False -> (rec'5 (p'3 * (2::Int))) })
  rec' p = let
        _0 = p * (2::Int)
        rec'3 p'2 = 
              let _5 = p'2 + (1::Int) in
