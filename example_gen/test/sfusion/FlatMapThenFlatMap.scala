...
((xs_0: scala.collection.IndexedSeq[scala.collection.IndexedSeq[scala.collection.IndexedSeq[scala.Int]]]) => {
  val x_1 = xs_0.size;
  val x_2 = new sfusion.Sequence[scala.collection.IndexedSeq[scala.collection.IndexedSeq[scala.Int]]]((() => sfusion.impl.`package`.fromIndexed[scala.collection.IndexedSeq[scala.collection.IndexedSeq[scala.Int]]](xs_0)), scala.`package`.Left.apply[scala.Int, Nothing](x_1));
  val x_8 = x_2.flatMap[sfusion.Sequence[scala.Int]](((a_3: scala.collection.IndexedSeq[scala.collection.IndexedSeq[scala.Int]]) => {
    val x_4 = a_3.size;
    val x_5 = new sfusion.Sequence[scala.collection.IndexedSeq[scala.Int]]((() => sfusion.impl.`package`.fromIndexed[scala.collection.IndexedSeq[scala.Int]](a_3)), scala.`package`.Left.apply[scala.Int, Nothing](x_4));
    x_5.map[sfusion.Sequence[scala.Int]](((is_6: scala.collection.IndexedSeq[scala.Int]) => {
      val x_7 = is_6.size;
      new sfusion.Sequence[scala.Int]((() => sfusion.impl.`package`.fromIndexed[scala.Int](is_6)), scala.`package`.Left.apply[scala.Int, Nothing](x_7))
    }))
  }));
...
// Transfo time: 8ms  Stringifying time: 25ms
...
((xs_0: scala.collection.IndexedSeq[scala.collection.IndexedSeq[scala.collection.IndexedSeq[scala.Int]]]) => {
  ...
  val x_8 = x_2.flatMap[scala.Int](((x$1_3: scala.collection.IndexedSeq[scala.collection.IndexedSeq[scala.Int]]) => {
    val x_4 = x$1_3.size;
    val x_5 = new sfusion.Sequence[scala.collection.IndexedSeq[scala.Int]]((() => sfusion.impl.`package`.fromIndexed[scala.collection.IndexedSeq[scala.Int]](x$1_3)), scala.`package`.Left.apply[scala.Int, Nothing](x_4));
    x_5.flatMap[scala.Int](((x_6: scala.collection.IndexedSeq[scala.Int]) => {
      val x_7 = x_6.size;
      new sfusion.Sequence[scala.Int]((() => sfusion.impl.`package`.fromIndexed[scala.Int](x_6)), scala.`package`.Left.apply[scala.Int, Nothing](x_7))
    }))
  }));
...
// Transfo time: 7ms  Stringifying time: 35ms
...
((xs_0: scala.collection.IndexedSeq[scala.collection.IndexedSeq[scala.collection.IndexedSeq[scala.Int]]]) => {
  ...
  val x_16 = new sfusion.Sequence[scala.Int]((() => {
    ...
    sfusion.impl.`package`.flatMap[scala.collection.IndexedSeq[scala.collection.IndexedSeq[scala.Int]], scala.Int](x_4)(((x_5: scala.collection.IndexedSeq[scala.collection.IndexedSeq[scala.Int]]) => {
      val x_6 = x_5.size;
      val x_7 = new sfusion.Sequence[scala.collection.IndexedSeq[scala.Int]]((() => sfusion.impl.`package`.fromIndexed[scala.collection.IndexedSeq[scala.Int]](x_5)), scala.`package`.Left.apply[scala.Int, Nothing](x_6));
      val x_14 = new sfusion.Sequence[scala.Int]((() => {
        ...
        sfusion.impl.`package`.flatMap[scala.collection.IndexedSeq[scala.Int], scala.Int](x_9)(((x_10: scala.collection.IndexedSeq[scala.Int]) => {
          val x_11 = x_10.size;
          val x_12 = new sfusion.Sequence[scala.Int]((() => sfusion.impl.`package`.fromIndexed[scala.Int](x_10)), scala.`package`.Left.apply[scala.Int, Nothing](x_11));
          val x_13 = x_12.under;
          x_13.apply()
        }))
...
// Transfo time: 6ms  Stringifying time: 12ms
...
// Transfo time: 11ms  Stringifying time: 43ms
...
// Transfo time: 147ms  Stringifying time: 219ms
    ...
    if (x_9.isDefined.`unary_!`)
      {
        while ({
          ...
          x_10.<(x_2).&&({
            ...
            var v_18: scala.Option[scala.Tuple2[scala.Int, scala.Tuple2[scala.Int, squid.lib.`package`.Var[scala.Int]]]] = scala.None;
            envVar_5 = scala.Some.apply[scala.Tuple2[scala.Int, scala.Tuple2[scala.Int, scala.Tuple2[squid.lib.`package`.Var[scala.Int], scala.Tuple2[squid.lib.`package`.Var[scala.Option[scala.collection.IndexedSeq[scala.Int]]], squid.lib.`package`.Var[scala.Option[scala.Tuple2[scala.Int, scala.Tuple2[scala.Int, squid.lib.`package`.Var[scala.Int]]]]]]]]]](scala.Tuple2.apply[scala.Int, scala.Tuple2[scala.Int, scala.Tuple2[squid.lib.`package`.Var[scala.Int], scala.Tuple2[squid.lib.`package`.Var[scala.Option[scala.collection.IndexedSeq[scala.Int]]], squid.lib.`package`.Var[scala.Option[scala.Tuple2[scala.Int, scala.Tuple2[scala.Int, squid.lib.`package`.Var[scala.Int]]]]]]]]](ClosureVar_14, scala.Tuple2.apply[scala.Int, scala.Tuple2[squid.lib.`package`.Var[scala.Int], scala.Tuple2[squid.lib.`package`.Var[scala.Option[scala.collection.IndexedSeq[scala.Int]]], squid.lib.`package`.Var[scala.Option[scala.Tuple2[scala.Int, scala.Tuple2[scala.Int, squid.lib.`package`.Var[scala.Int]]]]]]]](ClosureVar_15, scala.Tuple2.apply[squid.lib.`package`.Var[scala.Int], scala.Tuple2[squid.lib.`package`.Var[scala.Option[scala.collection.IndexedSeq[scala.Int]]], squid.lib.`package`.Var[scala.Option[scala.Tuple2[scala.Int, scala.Tuple2[scala.Int, squid.lib.`package`.Var[scala.Int]]]]]]](new squid.lib.VarProxy[scala.Int](ClosureVar_16, ((a) => ClosureVar_16 = a)), scala.Tuple2.apply[squid.lib.`package`.Var[scala.Option[scala.collection.IndexedSeq[scala.Int]]], squid.lib.`package`.Var[scala.Option[scala.Tuple2[scala.Int, scala.Tuple2[scala.Int, squid.lib.`package`.Var[scala.Int]]]]]](new squid.lib.VarProxy[scala.Option[scala.collection.IndexedSeq[scala.Int]]](ClosureVar_17, ((a) => ClosureVar_17 = a)), new squid.lib.VarProxy[scala.Option[scala.Tuple2[scala.Int, scala.Tuple2[scala.Int, squid.lib.`package`.Var[scala.Int]]]]](v_18, ((a) => v_18 = a)))))));
            false
          })
        }) 
          ()
          ...
          if (x_24.isDefined.`unary_!`)
            {
              while ({
                ...
                x_25.<(x_21.get._2._1).&&({
                  ...
                  sch_30._2.:=(scala.Some.apply[scala.Tuple2[scala.Int, scala.Tuple2[scala.Int, squid.lib.`package`.Var[scala.Int]]]](scala.Tuple2.apply[scala.Int, scala.Tuple2[scala.Int, squid.lib.`package`.Var[scala.Int]]](ClosureVar_35, scala.Tuple2.apply[scala.Int, squid.lib.`package`.Var[scala.Int]](ClosureVar_36, new squid.lib.VarProxy[scala.Int](v_37, ((a) => v_37 = a))))));
                  false
                })
              }) 
                ()
...
// Transfo time: 0ms  Stringifying time: 108ms

// Same as above.

// === VarFlattening ===

// Transfo time: 171ms  Stringifying time: 197ms
...
((xs_0: scala.collection.IndexedSeq[scala.collection.IndexedSeq[scala.collection.IndexedSeq[scala.Int]]]) => {
  ...
  var rhs_12: squid.lib.`package`.Var[scala.Option[scala.Tuple2[scala.Int, scala.Tuple2[scala.Int, squid.lib.`package`.Var[scala.Int]]]]] = squid.lib.`package`.uncheckedNullValue[squid.lib.`package`.Var[scala.Option[scala.Tuple2[scala.Int, scala.Tuple2[scala.Int, squid.lib.`package`.Var[scala.Int]]]]]];
    ...
    if (x_16.`unary_!`)
      {
        while ({
          ...
          x_17.<(x_3).&&({
            ...
            var v_25: scala.Option[scala.Tuple2[scala.Int, scala.Tuple2[scala.Int, squid.lib.`package`.Var[scala.Int]]]] = scala.None;
            lhs_8 = ClosureVar_21;
            lhs_9 = ClosureVar_22;
            ...
            flatVar_11 = x_27;
            rhs_12 = new squid.lib.VarProxy[scala.Option[scala.Tuple2[scala.Int, scala.Tuple2[scala.Int, squid.lib.`package`.Var[scala.Int]]]]](v_25, ((a) => v_25 = a));
            isDefined_7 = true;
            false
          })
        }) 
          ...
          if (x_33.isDefined.`unary_!`)
            {
              while ({
                ...
                x_34.<(x_35).&&({
                  ...
                  val x_43 = rhs_12;
                  x_43.:=(scala.Some.apply[scala.Tuple2[scala.Int, scala.Tuple2[scala.Int, squid.lib.`package`.Var[scala.Int]]]](scala.Tuple2.apply[scala.Int, scala.Tuple2[scala.Int, squid.lib.`package`.Var[scala.Int]]](ClosureVar_40, scala.Tuple2.apply[scala.Int, squid.lib.`package`.Var[scala.Int]](ClosureVar_41, new squid.lib.VarProxy[scala.Int](v_42, ((a) => v_42 = a))))));
                  false
                })
              }) 
                ()
...
// Transfo time: 38ms  Stringifying time: 180ms
...
((xs_0: scala.collection.IndexedSeq[scala.collection.IndexedSeq[scala.collection.IndexedSeq[scala.Int]]]) => {
  ...
  var rhs_11: squid.lib.`package`.Var[scala.Option[scala.Tuple2[scala.Int, scala.Tuple2[scala.Int, squid.lib.`package`.Var[scala.Int]]]]] = null;
        ...
        if (x_16.<(x_2))
          {
            ...
            var v_24: scala.Option[scala.Tuple2[scala.Int, scala.Tuple2[scala.Int, squid.lib.`package`.Var[scala.Int]]]] = scala.None;
            lhs_7 = ClosureVar_20;
            lhs_8 = ClosureVar_21;
            ...
            val x_26 = ClosureVar_23;
            flatVar_10 = x_26;
            rhs_11 = new squid.lib.VarProxy[scala.Option[scala.Tuple2[scala.Int, scala.Tuple2[scala.Int, squid.lib.`package`.Var[scala.Int]]]]](v_24, ((a) => v_24 = a));
            isDefined_6 = true
          }
        else
          ();
              ...
              if (x_33.<(x_34))
                {
                  ...
                  val x_42 = rhs_11;
                  x_42.:=(scala.Some.apply[scala.Tuple2[scala.Int, scala.Tuple2[scala.Int, squid.lib.`package`.Var[scala.Int]]]](scala.Tuple2.apply[scala.Int, scala.Tuple2[scala.Int, squid.lib.`package`.Var[scala.Int]]](ClosureVar_39, scala.Tuple2.apply[scala.Int, squid.lib.`package`.Var[scala.Int]](ClosureVar_40, new squid.lib.VarProxy[scala.Int](v_41, ((a) => v_41 = a))))))
                }
              else
                ();
              val x_43 = flatVar_9;
...
// Transfo time: 47ms  Stringifying time: 206ms
        ...
        if (x_16.<(x_2))
          {
            ...
            var ClosureVar_22: scala.Int = 0;
            var ClosureVar_23: scala.Option[scala.collection.IndexedSeq[scala.Int]] = scala.None;
            var x_24: scala.Option[scala.Tuple2[scala.Int, scala.Tuple2[scala.Int, squid.lib.`package`.Var[scala.Int]]]] = scala.None;
            lhs_7 = ClosureVar_20;
            lhs_8 = ClosureVar_21;
            val x_25 = ClosureVar_22;
            flatVar_9 = x_25;
            val x_26 = ClosureVar_23;
            flatVar_10 = x_26;
            rhs_11 = new squid.lib.VarProxy[scala.Option[scala.Tuple2[scala.Int, scala.Tuple2[scala.Int, squid.lib.`package`.Var[scala.Int]]]]](x_24, ((a) => x_24 = a));
            isDefined_6 = true
          }
        else
          ();
              ...
              if (x_33.<(x_34))
                {
                  ...
                  val x_42 = rhs_11;
                  x_42.:=(scala.Some.apply[scala.Tuple2[scala.Int, scala.Tuple2[scala.Int, squid.lib.`package`.Var[scala.Int]]]](scala.Tuple2.apply[scala.Int, scala.Tuple2[scala.Int, squid.lib.`package`.Var[scala.Int]]](ClosureVar_39, scala.Tuple2.apply[scala.Int, squid.lib.`package`.Var[scala.Int]](ClosureVar_40, new squid.lib.VarProxy[scala.Int](x_41, ((a) => x_41 = a))))))
                }
              else
                ();
              val x_43 = flatVar_9;
